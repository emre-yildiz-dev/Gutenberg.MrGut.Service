...
{
    public abstract class MrGutWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MrGutWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MrGutWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MrGutDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MrGutDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MrGutDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MrGutDbContext, Task<T>> func)
        {
            T result;
