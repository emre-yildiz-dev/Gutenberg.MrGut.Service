    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBookMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserBookMappings_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserBookMappings_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookMappings_BookId",
                table: "UserBookMappings",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookMappings_UserId",
                table: "UserBookMappings",
                column: "UserId");
